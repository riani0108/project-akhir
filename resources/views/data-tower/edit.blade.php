                ...
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="row mb-5">
                            ...
                            <form action="@isset($data){{route('data-tower.update', $data->id)}}@endisset" method="POST" id="frmdata" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="longtitude" class="form-label">Longtitude Tower</label>
                                    <input class="form-control" type="text" name="longtitude" id="longtitude" value="{{$data->longtitude ? $data->longtitude : old('longtitude')}}" required>
                                    <div id="datatowerHelp" class="form-text" style="color: #2f271d"> Text must be filled in as a number with units (m)</div>
                                </div>
                    ...
                    <script>
                        document.addEventListener("DOMContentLoaded", function() {
                            ...
                            var initialLon = "{{ $data->longtitude }}";
                            ...
                            map.on('click', function(e) {
                                ...
                                document.getElementById('longtitude').value = e.latlng.lng.toFixed(6);
                            });
