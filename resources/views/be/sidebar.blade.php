<div class="sidebar p-3" id="sidebar" style="width: 250px; transition: all 0.3s;">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="m-0">
            <a href="{{ route('admin.index') }}"
                class="text-decoration-none" style="color: #2f271d;">
                <i class="fas fa-broadcast-tower me-2"></i>Tower BTS
            </a>
        </h3>
        <button class="btn d-lg-none" id="sidebarClose" style="color: #2f271d;">
    ...
    <ul class="nav flex-column">
        ...
        <li>
            <a href="#"
                class="nav-link {{ request()->routeIs('statistik.index') ? 'active bg-#f0ae88' : '' }}">
        ...
        <li>
            <a href="#"
                class="nav-link {{ request()->routeIs('laporan.index') ? 'active bg-#f0ae88' : '' }}">
