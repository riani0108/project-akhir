                            ...
                            <form action="{{route ('data-antenna.store')}}" method="POST" id="frmdata" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="jenis_antenna" id="jenis_antenna" aria-label="Default select example">
                                        ...
                                        <option value="Omni" @if(old('jenis_antenna')=='Omni' ) selected @endif>Omni</option>
                                        <option value="Yagi" @if(old('jenis_antenna')=='Yagi' ) selected @endif>Yagi</option>
                                ...
                                <div class="form-group">
                                    <label for="tower" class="form-label">Pilih Tower</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="detail_lokasi" id="detail_lokasi" value="{{old('detail_lokasi')}}" required>
                                    <div id="dataantennaHelp" class="form-text" style="color: #2f271d"> Text must be filled in maximal 100 characters</div>
                                </div>
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" class="form-control" id="longtitude" name="longtitude" readonly required>
                                </div>
