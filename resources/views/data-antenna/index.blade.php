                            ...
                            <table class="table text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{strlen($data['detail_lokasi']) > 100 ? substr($data['detail_lokasi'], 0, 100) . '...' : $data['detail_lokasi']}}</td>
                                        <td>{{strlen($data['latitude']) > 100 ? substr($data['latitude'], 0, 100) . '...' : $data['latitude']}}</td>
                                        <td>{{strlen($data['longtitude']) > 100 ? substr($data['longtitude'], 0, 100) . '...' : $data['longtitude']}}</td>
